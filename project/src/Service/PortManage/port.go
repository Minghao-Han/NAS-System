...
func (port *Port) PrepareNewConnection(sourceIP net.IP, ctx *context.Context, ctxLock *sync.Mutex, wg *sync.WaitGroup, found chan *Port, connIndexChan chan int, cancel context.CancelFunc) {
